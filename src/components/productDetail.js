...
class ProductDetail extends React.Component{
    ...
    addBtnCart = () => {
        ...
        var newObj={}
        newObj={...this.state.product,id_product:this.state.product.id,id_user : this.props.id, qty:qty}
        delete newObj.id
                    ...
                    <div className='col-md-8'>
                        ...
                        :
                            <div className='row mt-4'>
                                ...
                                <input type='button' className='btn btn-success col-md-3' value='Add To Cart' onClick={this.addBtnCart} />
                            </div>
                        }
